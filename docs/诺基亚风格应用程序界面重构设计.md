...
```
用户    KeydroidxBoxFragment    NokiaAppOptionsDialog    Config
 │            │                    │                  │
 │──方向键───►│                    │                  │
 │            │ 高亮"手机QQ2008"   │                  │
 │            │                    │                  │
...
```
用户    KeydroidxBoxFragment    NokiaAppOptionsDialog    KeydroidxUninstallDialog    AppRepository
 │            │                    │                        │                    │
 │──左软键───►│                    │                        │                    │
 │            │ showAppOptionsMenu()│                       │                    │
 │            │──newInstance()────►│                        │                    │
...
- [ ] `NokiaAppOptionsDialog` 接入 `KeydroidxKeyBinding`，禁止写死 keyCode
