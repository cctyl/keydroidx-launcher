 ...
 * <p>
 * 继承自 {@link KeydroidxPageFragment}，专注于「纵向单列菜单/列表」页面，收编了各页面
 ...
 * <p>
 * 网格类（功能表、百宝箱等）和分页类继续直接继承 {@link KeydroidxPageFragment}，不进本基类。
 *
 * @see KeydroidxPageFragment
 * @see #onDirection(int)
 * @see #onLeftRight(int)
...
public abstract class KeydroidxListPageFragment extends KeydroidxPageFragment {
	...
	/**
	 * 子类可覆写此方法临时禁用方向键导航（如 {@code KeydroidxKeyBindFragment} 的确认弹窗态）。
