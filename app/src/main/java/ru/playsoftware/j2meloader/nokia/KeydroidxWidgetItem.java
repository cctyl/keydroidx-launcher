 ...
 */
public class KeydroidxWidgetItem {
	...
	public KeydroidxWidgetItem(int type, String label) {
		this(type, label, null, null);
	}

	public KeydroidxWidgetItem(int type, String label, String value) {
		this(type, label, value, null);
	}

	public KeydroidxWidgetItem(int type, String label, String value, String iconPath) {
		this.type = type;
		this.label = label;
		this.value = value;
	...
	public static KeydroidxWidgetItem fromJson(JSONObject json) throws JSONException {
		KeydroidxWidgetItem item = new KeydroidxWidgetItem(json.getInt("type"), json.getString("label"));
	...
	public boolean equals(Object o) {
		...
		KeydroidxWidgetItem that = (KeydroidxWidgetItem) o;
	...
	public static String getTypeIconUnicode(int type) {
		switch (type) {
			case TYPE_APP: return KeydroidxIcons.ICON_APP;
			case TYPE_URL: return KeydroidxIcons.ICON_URL;
			case TYPE_CALENDAR: return KeydroidxIcons.ICON_CALENDAR;
			case TYPE_ACTIVITY: return KeydroidxIcons.ICON_ACTIVITY;
			case TYPE_MEMORY: return KeydroidxIcons.ICON_MEMORY;
			case TYPE_STORAGE: return KeydroidxIcons.ICON_STORAGE;
			case TYPE_USAGE: return KeydroidxIcons.ICON_USAGE;
			case TYPE_LOCK_SCREEN: return KeydroidxIcons.ICON_LOCK;
			case TYPE_BG_MANAGER: return KeydroidxIcons.ICON_BG_MANAGER;
			case TYPE_IP: return KeydroidxIcons.ICON_IP;
			case TYPE_QS_TILE: return KeydroidxIcons.ICON_QS_TILE;
			case TYPE_MUSIC_PLAYER: return KeydroidxIcons.ICON_MUSIC_NOTE;
			default: return KeydroidxIcons.ICON_APP;
		}
	}
