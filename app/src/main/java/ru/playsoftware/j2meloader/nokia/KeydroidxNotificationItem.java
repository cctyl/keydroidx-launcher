 ...
 * 通知中心里的一个通知条目。
 * <p>
 * 由 {@link KeydroidxNotificationRepository} 从系统 {@link android.service.notification.StatusBarNotification}
 * 转换而来：{@link android.service.notification.StatusBarNotification} 是系统对象且随通知更新不断重建，
 * 不能长期持有，因此转成不可变的业务模型后再交给 UI 层。
 */
public class KeydroidxNotificationItem {
	...
	public KeydroidxNotificationItem(String key, String pkg, String appName, String title, String text,
