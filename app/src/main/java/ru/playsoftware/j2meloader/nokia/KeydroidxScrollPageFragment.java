...
public abstract class KeydroidxScrollPageFragment extends KeydroidxPageFragment {
	...
	protected void onPageCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
		...
		KeydroidxLog.d("KeydroidxScroll", "onPageCreated found pageScrollView=" + pageScrollView);
	...
	protected int getScrollStepPx() {
		...
		if (getContext() != null) {
			return KeydroidxDimens.dp(getResources(), 100);
		}
		return 160;
	}
	...
	public boolean scrollUp() {
		if (pageScrollView != null) {
			...
			KeydroidxLog.d("KeydroidxScroll", "scrollUp: height=" + pageScrollView.getHeight() + ", step=" + step + ", scrollY=" + pageScrollView.getScrollY());
	...
	public boolean scrollDown() {
		if (pageScrollView != null) {
			int step = getScrollStepPx();
			KeydroidxLog.d("KeydroidxScroll", "scrollDown: height=" + pageScrollView.getHeight() + ", step=" + step + ", scrollY=" + pageScrollView.getScrollY());
			pageScrollView.smoothScrollBy(0, step);
			return true;
		}
		return false;
	...
	public boolean onDirection(int action) {
		KeydroidxLog.d("KeydroidxScroll", "onDirection called with action=" + action + ", pageScrollView=" + pageScrollView);
		if (action == KeydroidxKeyBinding.ACTION_UP) {
			return scrollUp();
		} else if (action == KeydroidxKeyBinding.ACTION_DOWN) {
			return scrollDown();
		}
		return false;
	}
