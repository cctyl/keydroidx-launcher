 ...
 * <p>
 * 只做一件事——按身份派发进程级密钥 K（{@link KeydroidxShizukuKeyHolder}），不代理命令执行：
 * <ul>
 ...
 */
public class KeydroidxShizukuProvider extends ContentProvider {
    ...
    private Bundle bundleWithKey() {
        Bundle b = new Bundle();
        b.putString(MiniShizukuConst.EXTRA_KEY, KeydroidxShizukuKeyHolder.get());
        return b;
    }
